...
- <span style="color:blue">train/subject_train.txt</span>: Each row identifies the subject who performed the activity for each window sample in training set.
...
**1. time-domain signals - from the capture of accelerometer (*g*'s, 9.81 m.s⁻²) and gyroscope (radians per second, rad.s⁻¹) raw signals**
